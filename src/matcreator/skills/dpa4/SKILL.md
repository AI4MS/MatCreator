...
### Step 2a — Submit via the bohrium skill

Submit the finetune job on Bohrium using the `bohrium` skill. See the
`bohrium` skill documentation for submission details.
...
> **`backward_files` must include ALL outputs of the command chain.**
